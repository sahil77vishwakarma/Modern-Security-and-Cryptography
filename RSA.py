...
# step 3 : Compute lambda (lcm(n) = λ(n) = lcm(λ(p), λ(q)), λ(p) = p − 1, λ(q) = q − 1 , lcm(a,b) = |ab|/gcd(a,b)
...
# Step 5 : solve for d the equation de ≡ 1 (mod λ(n))
d = get_d(e, lambda_n)
...
m = c**d % n
print("Alice message : ", n)


#This is Eve
print()
print("Eve seems the following: ")
print("   Public key (e, n): ", e, n)
