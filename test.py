...
#         # what attributes does a library in general have? - for now, let's abstract and just say it has
#         # availablebooks (we're not going to program the shelves, and walls in!)
